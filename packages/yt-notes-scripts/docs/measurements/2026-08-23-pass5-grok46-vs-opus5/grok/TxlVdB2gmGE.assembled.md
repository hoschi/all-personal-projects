...
- Der gezeigte End-to-End-Workflow (YouTube-Transkript → Obsidian-Zusammenfassung → Slack-Kontext → GitHub-Issue → Claude-Code-Agent) war in 10 Minuten mit MCP-Servern eingerichtet. ([0:00](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=0s))
- In der klassischen GitHub-Registry muss man pro MCP-Server die JSON-Konfiguration selbst heraussuchen und eintragen. ([0:00](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=0s))
- Der Docker MCP Catalog macht Finden und Verbinden von MCP-Servern laut Sprecher „100 times easier“. ([0:00](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=0s))
- Ein Klick verbindet gewählte Server mit Claude Code oder Claude Desktop. ([0:00](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=0s))
- Für den Catalog reicht die Installation von Docker Desktop. ([2:06](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=126s))
- Claude Code, Claude Desktop und Gemini CLI bekommen die Konfiguration automatisch, ohne eigenes JSON. ([3:00](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=180s))
- Fetch steht nach Popularität oben und hat über 500.000 Downloads; der Server zieht Inhalte aus einer URL. ([3:00](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=180s))
- Das MCP Toolkit ist in Beta; fehlt es, muss man es unter Docker-Einstellungen → Beta Features aktivieren. ([4:26](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=266s))
- Ask Gordon ist als einziger Client von Anfang an mit dem MCP Toolkit verbunden. ([4:26](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=266s))
- Gordon und das MCP Toolkit sind beide in Beta. ([4:26](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=266s))
- Die MCP-Tools laufen als Docker-Container: Start beim Tool-Call, Shutdown danach, kein Dauerbetrieb im Speicher. ([4:26](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=266s))
- Laut Sprecher ist das effizient und sicher. ([4:26](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=266s))
- Claude Desktop arbeitet laut Sprecher spürbar besser als Gordon, weil ein stärkeres LLM dahintersteckt. ([4:26](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=266s))
- Der offizielle GitHub-MCP hat beim Sprecher nicht funktioniert; die archivierte Variante schon. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- Slack-MCP braucht Team-ID, Channel-IDs, eine Slack-App und einen Bot-Token. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- GitHub-MCP braucht ein Personal Access Token. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- Obsidian-MCP braucht das Community-Plugin Local REST API und dessen API-Key. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- Mit vier Servern (GitHub, Obsidian, Slack, YouTube Transcripts) liefert GitHub allein 26 Tools. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- Der Sprecher vermutet, Gordon laufe auf etwas wie Gemini 2.5 Flash oder GPT-5 Nano und überfordere sich bei mehr als ein paar Tools. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- Gordon sei eher auf Docker-Themen feinabgestimmt. ([8:56](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=536s))
- Der Slack-Bot hatte nur Zugriff auf den Channel „research“. ([11:19](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=679s))
- Der Sprecher hat 50 GitHub-Repos. ([11:19](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=679s))
- Der kombinierte Workflow mit Sonnet 4.5 hat Transkript, Obsidian-Notiz, Slack-History, GitHub-Issue und `@claudefix`-Kommentar durchgezogen. ([14:19](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=859s))
- Der erste GitHub-Issue-Call schlug fehl; Sonnet 4.5 korrigierte sich und legte das Issue an. ([14:19](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=859s))
- Claude Code arbeitete das Issue in einem Feature-Branch ab und erstellte einen Pull Request. ([14:19](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=859s))
- Die MCP Gateway ist Dockers Open-Source-Lösung zum Orchestrieren und Verwalten von MCP-Servern. ([16:49](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1009s))
- HTTP streamable ist laut Sprecher das De-facto-Standardprotokoll für MCP. ([16:49](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1009s))
- Die lokal gestartete Gateway auf Port 8089 mit Streaming-Transport bedient dieselben im Catalog verbundenen Server. ([16:49](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1009s))
- Der n8n-MCP-Client spricht `host.docker.internal:8089` mit HTTP streamable an; lokal ohne Authentifizierung. ([19:59](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1199s))
- `Slack list channels` über n8n dauerte 1,5 Sekunden. ([19:59](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1199s))
- Der LiveKit-Voice-Agent mit derselben Gateway-URL nannte Archon als Repo mit den meisten Stars unter Colium0000. ([21:22](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1282s))
- Docker hat am Video mitgearbeitet. ([22:35](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1355s))
- Der Catalog sei der einfachste Weg, externe Funktionen in AI-Agenten zu bringen. ([22:35](https://www.youtube.com/watch?v=TxlVdB2gmGE&t=1355s))
