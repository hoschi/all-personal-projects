...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        TABS_TRIGGER_BASE_CLASS,
        TABS_TRIGGER_VARIANT_CLASS,
        TABS_TRIGGER_STATE_CLASS,
        TABS_TRIGGER_INDICATOR_CLASS,
        className,
      )}
      {...props}
    />
