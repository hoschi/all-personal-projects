...
export const recurringItemIntervalSchema = z.enum(
  Object.values(RecurringItemInterval),
)
...
export type SnapshotAccountBalances = z.infer<
  typeof snapshotAccountBalancesSchema
>
...
export const forecastScenarioChanges = scenarioItemSchema.pick({
  isActive: true,
  id: true,
})
